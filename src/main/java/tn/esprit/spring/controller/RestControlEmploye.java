...
public class RestControlEmploye {
	...
	public Employe ajouterEmploye(@RequestBody EmployeDTO employe)
	{
		...
		Employe empEntity = modelMapper.map(employe, Employe.class);
		iemployeservice.ajouterEmploye(empEntity);
		return empEntity;
	}
	...
	public int ajouterContrat(@RequestBody ContratDTO contrat) {
		Contrat contratEntity = modelMapper.map(contrat, Contrat.class);
		iemployeservice.ajouterContrat(contratEntity);
		return contratEntity.getReference();
	}
